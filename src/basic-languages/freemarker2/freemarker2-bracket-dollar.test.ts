...
testTokenization("freemarker2.tag-bracket.interpolation-dollar", [
	// Plain text
	[
		{
			line: "abc123./]})>",
		...
		// Angle tag syntax is plain text in bracket tag syntax mode
		{
			line: '<#if user == "Big Joe"> Hello user </#if>',
			tokens: [{ startIndex: 0, type: "source.freemarker2" }],
		},
		// Bracket interpolation syntax is plain text in dollar interpolation syntax mode
		{
			line: "Hello, [=user] !",
			tokens: [{ startIndex: 0, type: "source.freemarker2" }],
		},
