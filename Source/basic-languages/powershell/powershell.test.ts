...
testTokenization("powershell", [
	...
	[
		{
			line: "0",
			tokens: [{ startIndex: 0, type: "number.ps1" }],
		},
	],
	...
	[
		{
			line: "0.10",
			tokens: [{ startIndex: 0, type: "number.float.ps1" }],
		},
	],
	...
	[
		{
			line: "0X123",
			tokens: [{ startIndex: 0, type: "number.hex.ps1" }],
		},
	],
	...
	[
		{
			...
			tokens: [{ startIndex: 0, type: "string.ps1" }],
		},
	],
	...
	[
		...
		{
			line: "${script:foo}",
			tokens: [{ startIndex: 0, type: "variable.ps1" }],
		},
		{
			line: "foreach $i",
			tokens: [
	...
	[
		...
		{
			line: "{",
			tokens: [{ startIndex: 0, type: "delimiter.curly.ps1" }],
		},
		{
		...
		{
			line: ":aLabel",
			tokens: [{ startIndex: 0, type: "metatag.ps1" }],
		},
		{
			line: "",
			tokens: [],
		...
		{
			line: ".SYNOPSIS",
			tokens: [{ startIndex: 0, type: "comment.keyword.synopsis.ps1" }],
		},
		{
			line: "  some text",
			tokens: [{ startIndex: 0, type: "comment.ps1" }],
		...
		{
			line: ".LINK",
			tokens: [{ startIndex: 0, type: "comment.keyword.link.ps1" }],
		},
		{
			line: "  some more text",
			tokens: [{ startIndex: 0, type: "comment.ps1" }],
