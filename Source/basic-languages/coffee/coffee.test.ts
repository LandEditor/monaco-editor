...
testTokenization("coffeescript", [
	...
	[
		{
			line: "'''",
			tokens: [{ startIndex: 0, type: "string.coffee" }],
		},
	],
	...
	[
		{
			line: "0",
			tokens: [{ startIndex: 0, type: "number.coffee" }],
		},
	],
	...
	[
		{
			line: "0123",
			tokens: [{ startIndex: 0, type: "number.octal.coffee" }],
		},
	],
	...
	[
		{
			line: "0x123",
			tokens: [{ startIndex: 0, type: "number.hex.coffee" }],
		},
	],
	...
	[
		{
			line: "/ /",
			tokens: [{ startIndex: 0, type: "regexp.coffee" }],
		},
	],
	...
	[
		...
		{
			line: "]",
			tokens: [{ startIndex: 0, type: "delimiter.square.coffee" }],
		},
		{
			line: "",
			tokens: [],
		...
		{
			line: "else",
			tokens: [{ startIndex: 0, type: "keyword.else.coffee" }],
		},
		{
			line: "  showIt()",
			tokens: [
		...
		{
			line: "try",
			tokens: [{ startIndex: 0, type: "keyword.try.coffee" }],
		},
		{
		...
		{
			line: "finally",
			tokens: [{ startIndex: 0, type: "keyword.finally.coffee" }],
		},
		{
			line: "  cleanUp()",
			tokens: [
