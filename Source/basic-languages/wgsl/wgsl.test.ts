...
const cases: ITestItem[][] = [
	...
	[
		...
		{
			line: "discard",
			tokens: [{ startIndex: 0, type: "meta.content.wgsl" }],
		},
		{
			line: "else",
			tokens: [{ startIndex: 0, type: "meta.content.wgsl" }],
	...
	[
		...
		{
			line: "}",
			tokens: [{ startIndex: 0, type: "delimiter.curly.wgsl" }],
		},
	],
	// predeclared
	[
	...
	[
		...
		{
			line: "asm_fragment",
			tokens: [{ startIndex: 0, type: "invalid.wgsl" }],
		},
	...
	[
		{
			line: "@vertex",
			tokens: [{ startIndex: 0, type: "annotation.wgsl" }],
		},
		{
